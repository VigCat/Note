...
<html>
				...
				<div class="menuItems">
					<ul class="">
						...
						<li class="menuItem">
							...
							<div class="m-item-desc">menudsadsaddsad</div>
						</li>
						<li class="menuItem">
							<div class="m-item-icon">
								<img src="<%=basePath%>/img/icon/icon.png" />
			...
			<div class="container-content" style="">
				<div class="content-article">
					...
					<div class="article-content">
						...
						<div class="footer">213dsa dsa dsa 21321321321</div>
					</div>
				</div>
			</div>
	...
	<script id="UEditorInitJS" src="<%=basePath%>/js/UEditor_init.js" type="text/javascript"></script>
	<script type="text/javascript">
		$(function() {
			$("#UEditorInitJS").attr("src", "<%=basePath%>/js/UEditor_init.js");
			var GLOBLE = {
				article: {
					title: "",
					url: "",
